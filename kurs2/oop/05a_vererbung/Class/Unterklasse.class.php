...
if(DEBUG_C) 			echo "<h3 class='debugClass'><b>Line " . __LINE__ . "</b>: Aufruf " . __METHOD__ . "() (<i>" . basename(__FILE__) . "</i>)</h3>";						
						...
						// Methode "HelloWorld" der Oberklasse aufrufen:
						parent::HelloWorld();
						
						echo "<h3>Unterklasse sagt: <i>Ich bin die Unterklasse. Eben habe ich eine Methode meiner Elternklasse auggerufen.</i></h3>";
					}
